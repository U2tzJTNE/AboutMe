...
public class UpdateAccountInfoActivity extends AppCompatActivity {
    ...
    private void initUpdateType() {
        ...
        if (intent != null) {
            update_type = intent.getIntExtra(Const.UPDATE_ACCOUNT_INFO_TYPE, Const.REQUEST_CODE_NICKNAME);
        } else {
            update_type = Const.REQUEST_CODE_NICKNAME;
        }
    }
    ...
    private void initUI() {
        ...
        switch (update_type) {
            case Const.REQUEST_CODE_NICKNAME:
            ...
            case Const.REQUEST_CODE_EMAIL:
                ...
                break;
            case Const.REQUEST_CODE_PASSWORD:
    ...
    private void updateInfoAction() {
        ...
        if (!TextUtils.isEmpty(text)) {
            //更新信息
            switch (update_type) {
                case Const.REQUEST_CODE_EMAIL://邮件
                    //1.验证是不是正确的邮件地址
                    //2.更新
                    ...
                    break;
                case Const.REQUEST_CODE_NICKNAME://用户名
                    ...
                    break;
                case Const.REQUEST_CODE_PASSWORD://密码
            ...
            public void done(BmobException e) {
                ...
                if (e == null) {
                    if (type == UpdateType.EMAIL) {
                        ...
                        startActivity(new Intent(UpdateAccountInfoActivity.this, LoginActivity.class));
                    } else {
                        ToastUtil.s("更新成功");
                    }
                    finish();
