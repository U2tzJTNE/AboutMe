...
/**
 * Created by JK on 2017/11/23.
 */

public class CProgressButton extends AppCompatButton implements ProgressListener {
    ...
    private static String[] statusString = new String[]{"下载", "等待", "暂停", "重试", "安装"};
    ...
    private void morph2Normal() {
        ...
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator cornerAnimation =
